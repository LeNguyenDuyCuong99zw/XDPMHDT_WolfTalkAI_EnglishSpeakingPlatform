...
export const LearningLoginPage: React.FC<LearningLoginPageProps> = () => {
  ...
  // Don't force logout on page load - user might be already logged in
  // Only logout when they explicitly click logout button
